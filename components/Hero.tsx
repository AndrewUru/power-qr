  ...
  <div className="custom-screen pt-28 text-gray-600">
    <div className="space-y-5 max-w-4xl mx-auto text-center">
      ...
      <p className="max-w-xl mx-auto">
        Con PowerQRGPT, crear un código QR nunca fue tan fácil (ni tan cool). Deja que la IA haga el trabajo y obtén un QR con estilo en segundos. Y sí, ¡es completamente gratis!
      </p>
